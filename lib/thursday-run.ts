...
export const thursdayRun = {
  ...
  analyzedCount: 18,
  blockedCount: 5,
  transcriptStatus: 'BLOCKED_MODEL_DEPENDENCY',
  finalRankingStatus: 'PROVISIONAL_VISUAL_AUDIO_ONLY',
  items: [
    { id:'img-8006', file:'IMG_8006.MOV', format:'LONG-FORM ANCHOR', duration:133.5117, orientation:'vertical', visualScore:.889, focus:795.9, audioUse:'GOOD_CLEAN_BUT_NORMALIZE', note:'Frew seated card Q&A; 2:13 take; DJI transmitter visible; strong portrait framing.', status:'REVIEW', reason:'Primary anchor candidate. Transcript required before semantic ranking or copy.' },
    { id:'mvi-8501', file:'MVI_8501.MOV', format:'LONG-FORM ANCHOR', duration:83.1831, orientation:'horizontal', visualScore:.865, focus:899.2, audioUse:'GOOD_CLEAN_BUT_NORMALIZE', note:'Frew seated card Q&A; strong DSLR wide/medium framing; likely external receiver audio.', status:'REVIEW', reason:'Primary anchor candidate. Transcript required before semantic ranking or copy.' },
    { id:'img-6862', file:'IMG_6862.MOV', format:'REEL / SHORT', duration:8.12, orientation:'vertical', visualScore:.89, focus:1011.9, audioUse:'USABLE_WITH_GAIN_REVIEW', note:'Centered Frew vertical talking-head; short take.', status:'REVIEW', reason:'Short-form candidate; no transcript yet.' },
    { id:'img-6863', file:'IMG_6863.MOV', format:'REEL / SHORT', duration:9.553333, orientation:'vertical', visualScore:.879, focus:1005, audioUse:'USABLE_WITH_GAIN_REVIEW', note:'Centered Frew vertical talking-head; short take with visible gesture.', status:'REVIEW', reason:'Short-form candidate; no transcript yet.' },
    { id:'img-6864', file:'IMG_6864.MOV', format:'REEL / SHORT', duration:6.485, orientation:'vertical', visualScore:.914, focus:1000.1, audioUse:'WEAK_DISTANT_OR_LOW_LEVEL', note:'Centered Frew vertical talking-head; strong frame.', status:'REVIEW', reason:'Strong visual; audio needs review and transcript is unavailable.' },
    { id:'img-6865', file:'IMG_6865.MOV', format:'REEL / SHORT', duration:15.0717, orientation:'vertical', visualScore:.911, focus:1010.2, audioUse:'USABLE_WITH_GAIN_REVIEW', note:'Centered Frew vertical talking-head; short take.', status:'REVIEW', reason:'Short-form candidate; no transcript yet.' },
    ...
    { id:'img-6870', file:'IMG_6870.MOV', format:'TAMARA', duration:42.668333, orientation:'vertical', visualScore:.88, focus:443.5, audioUse:'USABLE_TO_GOOD', note:'Tamara exterior on-camera/walk; useful vertical speaking take.', status:'REVIEW', reason:'Strong Tamara candidate; transcript required before copy.' },
    { id:'img-6872', file:'IMG_6872.MOV', format:'TAMARA', duration:45.636667, orientation:'vertical', visualScore:.81, focus:132.7, audioUse:'USABLE_TO_GOOD', note:'Tamara interior walkthrough / room-rating movement.', status:'REVIEW', reason:'Useful Tamara candidate; transcript required before copy.' },
    ...
    ...['IMG_6866.MOV','IMG_6871.MOV','MVI_8496.MOV','MVI_8499.MOV','MVI_8502.MOV'].map((file) => ({ id:`blocked-${file.toLowerCase()}`, file, format:'BLOCKED MASTER' as const, note:'Oversized master was not analyzed in the Drive worker run.', status:'BLOCKED' as const, reason:'Transfer returned 413. Must be processed before final S/A/B ranking.' })),
